#SQ4lite+libe plopper.py file__modified:
...
class Plopper:
    ...
    def findRuntime(self, x, params, worker):
       ...
       #cmd1 = "ftn -O3 -xmic-avx512 -fopenmp -dynamic -c ../src/type_defs.f90 " \
       #         + " ; CC -O3 -I../src -xmic-avx512 -fopenmp -dynamic -DSW4_OPENMP -DSW4_CROUTINES -DSW4_CROUTINES  -I../src/double "  + \
       ...
       # cmd1 = "ftn -O3 -xmic-avx512 -fopenmp -dynamic -c ../src/type_defs.f90 " \
       #         + " ; CC -O3 -I../src -xmic-avx512 -fopenmp -dynamic -DSW4_OPENMP -DSW4_CROUTINES -DSW4_CROUTINES  -I../src/double "  + \
       #         " -o " + tmpbinary + "../src/main.C" + interimfile +" "+ kernel_dir + \
       #         "../src/Sarray.C ../src/Source.C ../src/SuperGrid.C ../src/GridPointSource.C ../src/time_functions.C ../src/EW_cuda.C ../src/ew-cfromfort.C ../src/EWCuda.C ../src/CheckPoint.C ../src/Parallel_IO.C ../src/EW-dg.C ../src/MaterialData.C ../src/MaterialBlock.C ../src/Polynomial.C ../src/SecondOrderSection.C ../src/Filter.C ../src/TimeSeries.C ../src/sacsubc.C ../src/curvilinear-c.C " \
       #         + " -I" + kernel_dir + \
       #         " -lm"

        cmd1 = "mpif90 -fopenmp -dynamic -c src/type_defs.f90 " \
                + " ; mpicxx -I./src -fopenmp -dynamic -DSW4_OPENMP -DSW4_CROUTINES -DSW4_CROUTINES  -I./src/double"  + \
                " -o " + tmpbinary + "src/main.C" + interimfile +" " + \
                "src/Sarray.C src/Source.C src/SuperGrid.C src/GridPointSource.C src/time_functions.C src/EW_cuda.C src/ew-cfromfort.C src/EWCuda.C src/CheckPoint.C src/Parallel_IO.C src/EW-dg.C src/MaterialData.C src/MaterialBlock.C src/Polynomial.C src/SecondOrderSection.C src/Filter.C src/TimeSeries.C src/sacsubc.C src/curvilinear-c.C " \
                + " -I" + kernel_dir + \
                " -lm"   
