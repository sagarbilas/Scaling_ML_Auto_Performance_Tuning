...
sim_specs = {
    ...
    'in': ['p0', 'p1', 'p2', 'p3', 'p4'],
    #'out': [('RUNTIME', float)],
    #'out': [('RUNTIME', float), ('startMinusEnd', float), ('elapsed_secs', float)],
    'out': [('RUNTIME', float),('elapsed_sec', float)],
}

cs = CS.ConfigurationSpace(seed=234)
# Initialize the ytopt ask/tell interface (to be used by the gen_f)
# number of threads
p0 = CSH.OrdinalHyperparameter(name='p0', sequence=[8,16,32,64,128,192,256], default_value=64)
...
gen_specs = {
    ...
    #'persis_in': sim_specs['in'] + ['RUNTIME', 'sim_started_time', 'sim_ended_time', 'startMinusEnd','elapsed_secs'],
